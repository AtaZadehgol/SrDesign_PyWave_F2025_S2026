...
"""
#this is the old config file -- NOT IN USE
...
# Geometry
sgl_wg_length = 25.0e-6        # Waveguide length (m, float)
...
#should be able to change these (nx and ny)
...
gp_tpk = 9 * gp_tsp
#should be able to change the 9 - coefficient of gp_tsp

# Wave packet spread and peak time
wp_tsp = 2 * np.sqrt( np.log( 2 ) ) / ( wave_packet_bw * 2 * np.pi * f0 ) #omega always 2pi f
wp_tpk = 9 * wp_tsp
#should be able to change this 2 *, 9 *

...
#the 2 is coeff of how many 'slots' - should definitely be changeable
#number of cell edges - total grid is nx * ny
...
#the 0 should be a variable. represents where the user has put the wave on the waveguide
#will place the source, now we know where the source is
